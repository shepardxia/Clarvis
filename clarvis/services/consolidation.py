"""Two-layer memory consolidation: MEMORY.md (rolling) + dual memory system.
...
- A history entry fed into the memory system (Graphiti + memU)
"""
...
class ConversationConsolidator:
    ...
    def __init__(
        self,
        memory_service: Any = None,  # DualMemoryService
